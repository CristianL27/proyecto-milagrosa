...
public class Home extends javax.swing.JFrame {
    ...
    Empleados usr;
    public Home(Controladora control, Empleados usr ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        userBtn.setFont(new java.awt.Font("Georgia", 0, 18)); // NOI18N
        userBtn.setForeground(new java.awt.Color(255, 255, 255));
        userBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/document2.png"))); // NOI18N
        userBtn.setText("EMPLEADOS");
        userBtn.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 1, true));
        ...
        jPanel5.add(userBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, 260, 40));
        ...
        jPanel5.add(regisBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 260, 40));
    ...
    private void userBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userBtnMouseEntered
        userBtn.setBackground(new java.awt.Color(0, 102, 102, 255));
        userBtn.setFont(new java.awt.Font("Georgia", 1, 20));
    ...
    private void userBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userBtnMouseExited
        userBtn.setBackground(new java.awt.Color(0, 153, 153, 255));
        userBtn.setFont(new java.awt.Font("Georgia", 0, 18));
    }//GEN-LAST:event_userBtnMouseExited

    private void userBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userBtnActionPerformed
        Usuarios usuarios = new Usuarios(control, usr);
