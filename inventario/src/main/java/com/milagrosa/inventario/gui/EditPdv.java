...
public class EditPdv extends javax.swing.JFrame {
    ...
    public EditPdv(Controladora control, Empleados usr, Integer id_lote) {
        initComponents();
...
//        this.lote = lote;
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Editar Lote");
        titleLabel.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        jPanel14.add(titleLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 60, -1, -1));
        ...
        jPanel14.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 90, 180, 1));
        ...
        jPanel14.add(saveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 380, 110, 40));
        ...
        jPanel14.add(cleanBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 380, 110, 40));
        ...
        jPanel14.add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 380, 110, 40));
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
                ...
                control.editLote(lote, monto, fecha );
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            Date fecha = dformat.parse(lote.getFecha());
          dateTxt1.setDate(fecha);
        } catch (ParseException ex) {
            Logger.getLogger(EditPdv.class.getName()).log(Level.SEVERE, null, ex);
        }
