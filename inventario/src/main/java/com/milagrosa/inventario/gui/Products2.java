...
public class Products2 extends javax.swing.JFrame {
    ...
    Empleados usr;
    public Products2(Empleados usr, Controladora control) {
        initComponents();
        this.usr = usr;
    ...
    private void initComponents() {
        ...
        productsTable.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        productsTable.setForeground(new java.awt.Color(0, 153, 153));
        ...
        productsTable.setSelectionBackground(new java.awt.Color(0, 102, 102));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(325, 30, -1, -1));
        ...
        jPanel1.add(searchTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 200, 30));

        jSeparator1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 120, 240, 1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/product2.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(455, 27, 30, 30));

        jSeparator2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(315, 55, 175, 1));
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        AddProduct addProduct = new AddProduct(control, usr);
...
//        EditProduct editProduct = new EditProduct(control, usr, id_producto);
...
//        this.dispose();
    ...
    private void verBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verBtnActionPerformed
        ...
        if (productsTable.getRowCount()>0){
            ...
            if(productsTable.getSelectedRow() != -1){
                ...
                Integer id_producto = Integer.parseInt( String.valueOf( productsTable.getValueAt(productsTable.getSelectedRow(),0))) ;

                //llamar ventana visualizar
                VerProduct verProduct = new VerProduct(control, usr, id_producto);
                verProduct.setVisible(true);
                verProduct.setLocationRelativeTo(null);
                this.dispose();
    ...
    private void cargarTabla() {
        ...
        String titulos[] = {"Id","Nombre","Descripcción", "Cantidad", "Precio"};
        ...
        if(listaProductos != null){
            ...
            for(Productos prod : listaProductos){
                Object[] objeto = {prod.getId_producto() ,prod.getNombre(), prod.getDescripccion(), prod.getCantidad(), prod.getPrecio()};
                
                modeloTabla.addRow(objeto);
            }
        }
        
        productsTable.setModel(modeloTabla);
    }
}
